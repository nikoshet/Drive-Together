...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" type="text/css" href="style/adminSettings.css">
            ...
            <div class="container-fluid">               
                <div class="navbar" id="myNavbar">
                    <ul class="nav navbar-nav col-md-12">
						...
						<li class="menubutton active"><hadmin style="text-align:center;"><a class=" ss ssb" href="adminSettings.php">
...
<!--!!!!!!!!!!!!!!! Choose Recommened Offers !!!!!!!!!!!!!!!!!-->		
			<div class="container viewTrips">
				<div class="col-md-9 col-xs-12">
					<h3 class="headline">
					Choose 3 Trips For Recommened Offers
					</h3>
					<div class="row">
				...
				<div class="col-md-3 col-xs-12 select">
					<h3 class="headline ">
					Select
					</h3>
					<div class="row">
						<div class="col-xs-12 col-md-5">
							<div class="selections">
							 	<b><dd class="selected">0</dd>/3</b> selected
 							</div>
						</div>
						<div class="col-xs-12 col-md-7">
							<div class="update">
							 	<button type='button' class='btn btn-info btn-block' id='update'>Update Offers</button>
							</div>
						</div>
					</div>				
				</div>	
