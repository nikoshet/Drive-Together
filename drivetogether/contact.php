...
<html lang="en">
  <head>
    <title>DRIVE TOGETHER - Contact</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <div class="container-fluid">               
                <div class="navbar" id="myNavbar">
                    <ul class="nav navbar-nav col-md-12">
						...
						<li class="menubutton active"><a href="contact.php">Contact</a></li>
						<?php 
		...
		<div class="container-fluid "> 
			<div class="row" id="contact">
				...
				<div class="col-md-5 col-xs-10">
					<h1><b>Contact</b></h1>
					<p class="t1">For any questions you have or more information
					about us please feel free<br> to contact us via the following ways: </br>
					<div>
						<i class="fa fa-envelope"></i>
						<p><span>drivetogetherteam@gmail.com</span></p>
					</div>
					...
					<div>
						...
						<p><span>University of Patras</span> Patras, Greece</p>
					</div>
				</div>
				<div class="col-md-5 col-xs-10 logo animated fadeInRight">
